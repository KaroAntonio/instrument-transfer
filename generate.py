...
X_train = np.load('./datasets/batman-piano_x.npy')
y_train = np.load('./datasets/vibra_y.npy')
X_mean = np.load('./datasets/batman-piano_mean.npy')
X_var = np.load('./datasets/batman-piano_var.npy')
