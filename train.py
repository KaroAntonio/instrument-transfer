...
X_train = np.load(inputFile + '/source_x.npy')
y_train = np.load(inputFile + '/target_y.npy')
...
num_iters = 20000 			#Number of iterations for training
save_iter = 50			# Number of iters between saves
